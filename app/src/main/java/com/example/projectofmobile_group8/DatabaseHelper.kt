...
class DatabaseHelper(private val context: Context) : SQLiteOpenHelper(context, DB_NAME, null, 1) {
    ...
    companion object {
        private const val DB_NAME = "Project_database.db" // Tên tệp cơ sở dữ liệu trong thư mục assets
        private const val DB_PATH = "/data/data/com.example.projectofmobile_group8/databases/" // Thay bằng package của bạn
    }
